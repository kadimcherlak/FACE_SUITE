...
Feature: Perform Edit on Employee Information
  ...
  @UPDATE_PAY_METHOD_WITH_NEW_BANK
  Scenario Outline: Employee to update Create Pay Method with New Bank
    Given user runs <Test Scenario> from <Test File Name> under <Test Sheet Name>
    And user login to Oracle Applications Cloud web page
    When user clicks on Navigator icon
    ...
    When user clicks Manage Personal Payment Methods option from task icon menu
    Then Person Management page is displayed
    And user selects update from Actions and then select Edit option
    And user clicks on Action button and select Edit option and deselect the Active tickbox and click on Save and Close button
    And user clicks on + icon under Bank Accounts
    Then Create Bank Account page should be displayed
    And enter the bank account details
    And user clicks on Submit button
  ...
  @UPDATE_PAY_METHOD_WITH_NEW_BANK_QUICK_ACTION
  Scenario Outline: Employee to update Create Pay Method with New Bank from Quick Action
    Given user runs <Test Scenario> from <Test File Name> under <Test Sheet Name>
    And user login to Oracle Applications Cloud web page
    When user clicks on Navigator icon
    And user clicks on Person Management link in Navigator Pane
  ...
  @UPDATE_PAY_METHOD_WITH_EXISTING_BANK
  Scenario Outline: Employee to update Create Pay Method with Existing Bank
    Given user runs <Test Scenario> from <Test File Name> under <Test Sheet Name>
    And user login to Oracle Applications Cloud web page
    When user clicks on Navigator icon
  ...
  @UPDATE_PAY_METHOD_WITH_EXISTING_BANK_QUICK_ACTION
  Scenario Outline: Employee to update Create Pay Method with New Bank from Quick Action
    Given user runs <Test Scenario> from <Test File Name> under <Test Sheet Name>
    And user login to Oracle Applications Cloud web page
    When user clicks on Navigator icon
  ...
  Scenario Outline: Employee edit phone number
    ...
    Examples:
      | Test Scenario        | Test File Name | Test Sheet Name  |
      | ADD_NEW_HOME_ADDRESS | TestData.xlsx  | Employee_Details |
